 ...
 *
 * This is an old version of GTextBox before I reworked it to use a JTextField instead.
 * Only reason this is help here is in case I break the new version.
 */
public class GTextBoxOLD implements GUIComponent, GMouseListener, GKeyListener, GAnimation {
     ...
     * @author Robert
     */
    public GTextBoxOLD(final int height, final String text) {
        this.height = height;
     ...
     * @author Robert
     */
    public GTextBoxOLD(final int height, final String text, final int maxLength) {
        this.height = height;
        this.font = new Font("Helvetica", Font.PLAIN, height - 6);
        this.text = text;
            ...
            if (e.getKeyChar() == KeyEvent.VK_TAB
                ...
                for (GUIComponent c : GUI.window.getItems()) {
                    if (c == this) {
                        ...
                        if (c instanceof GTextBoxOLD) {
                            selected = false;
                            ((GTextBoxOLD) c).selected = true;
                            break;
                        }
                    }
                }
